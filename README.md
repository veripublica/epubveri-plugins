...
| [`plugins/calibre-library`](plugins/calibre-library) | calibre's **library** view | **released — [0.5.3](https://github.com/veripublica/epubveri-plugins/releases/tag/calibre-library-v0.5.3)** |
...
`calibre-v0.4.5`, `calibre-library-v0.5.3`), because each is versioned independently — the tag says
...
plugins/          the products — one folder per editor
  ...
  calibre-library/  calibre's library view; shares nothing with the above
