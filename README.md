...
| plugin | for | status |
|---|---|---|
| [`plugins/sigil`](plugins/sigil) | [Sigil](https://sigil-ebook.com/) | **released — [0.3.1](https://github.com/veripublica/epubveri-plugins/releases/tag/sigil-v0.3.1)** |
| [`plugins/calibre`](plugins/calibre) | [calibre](https://calibre-ebook.com/)'s Edit Book | **released — [0.4.3](https://github.com/veripublica/epubveri-plugins/releases/tag/calibre-v0.4.3)** |
| [`plugins/calibre-library`](plugins/calibre-library) | calibre's **library** view | **released — [0.1.1](https://github.com/veripublica/epubveri-plugins/releases/tag/calibre-library-v0.1.1)** |
...
unpacks it. Releases are tagged per plugin (`sigil-v0.3.1`,
`calibre-v0.4.3`, `calibre-library-v0.1.1`), because each is versioned independently — the tag says
