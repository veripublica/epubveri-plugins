...
| [`plugins/calibre`](plugins/calibre) | [calibre](https://calibre-ebook.com/)'s Edit Book | **released — [0.4.1](https://github.com/veripublica/epubveri-plugins/releases/tag/calibre-v0.4.1)** |
...
`calibre-v0.4.1`), because the two are versioned independently — the tag says
